...
A consulting-register briefing memorandum on the three leading AI providers in higher education — OpenAI, Anthropic, and Google. Prepared for **Babson President Steve Spinelli** and signed by **Erik Noyes**, **Kristi Girdharry**, and **Jonathan Sims**.
